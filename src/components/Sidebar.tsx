...
import DataRocksLogo from "./DataRocksLogo";
      ...
      <div className="flex items-center justify-between px-4 pt-5 pb-3">
        {!collapsed && (
          <div className="flex items-center gap-2">
            ...
            <div>
              <div className="text-[13px] font-black text-gray-900" style={{ letterSpacing: "0.1em" }}>
                DATA ROCKS
              </div>
              <div className="text-[9px] text-gray-400" style={{ letterSpacing: "0.03em" }}>
